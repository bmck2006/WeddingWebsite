...
*/
$emailto = 'bmckeown2011@gmail.com'; 	// Insert the email address that will receive the messages
$fromName = 'B&K 2017 Wedding RSVP';					// Insert a default "Name" email address (this field will be displayed in the email header)
$fromEmail = 'WeddingRSVP@BrianAndKayla2017.com';	// Insert a default "From" email address (this field will be displayed in the email header)
$subject = 'B&K 2017 Wedding RSVP';		// Insert a default contact form subject
